...
public final class MavlinkParser extends AbstractVerticle {
    ...
    private byte[] recordToRaw(RecordComponent c, Object o) {
        ...
        return switch (natType) {
            ...
            case UINT_16, INT_16 -> new byte[]{(byte) (((short) n.shortValue() >> 8) & 0xff), (byte) ((short) n.shortValue() & 0xff)};
            case UINT_32, INT_32 -> new byte[]{(byte) (((int) n.intValue() >> 24) & 0xff), (byte) (((int) n.intValue() >> 16) & 0xff),
                    (byte) (((int) n.intValue() >> 8) & 0xff), (byte) ((int) n.intValue() & 0xff)};
            case INT_64, UINT_64 -> new byte[]{(byte) (((long) n.intValue() >> 56) & 0xff), (byte) (((long) n.intValue() >> 48) & 0xff),
