...
/**
 * The RAW IMU readings for secondary 9DOF sensor setup. This message should contain the scaled values to the described units</br>
 * </br>
 ...
 */
@MavInfo(id = 116, crc = 76)
@SuppressWarnings("preview")
public record ScaledImu2(
        /**
