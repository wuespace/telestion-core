...
/**
 * A message containing logged data which requires a LOGGING_ACK to be sent back</br>
 * </br>
 ...
 */
@MavInfo(id = 267, crc = 35)
@SuppressWarnings("preview")
public record LoggingDataAcked(
        /**
