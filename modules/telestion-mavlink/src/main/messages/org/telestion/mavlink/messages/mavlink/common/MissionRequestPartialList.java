...
/**
 * Request a partial list of mission items from the system/component. https://mavlink.io/en/services/mission.html. If start and end index are the same, just send one waypoint.</br>
 * </br>
 ...
 */
@MavInfo(id = 37, crc = 212)
@SuppressWarnings("preview")
public record MissionRequestPartialList(
        /**
         * System ID</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
        ...
        /**
         * End index, -1 by default (-1: send list to end). Else a valid index of the list</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         */
        @MavField(nativeType = NativeType.INT_16)
    ...
    private MissionRequestPartialList() {
        this(0, 0, 0, 0, 0);
    }
}