...
/**
 * The RAW IMU readings for 3rd 9DOF sensor setup. This message should contain the scaled values to the described units</br>
 * </br>
 ...
 */
@MavInfo(id = 129, crc = 46)
@SuppressWarnings("preview")
public record ScaledImu3(
        /**
