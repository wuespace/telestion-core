...
/**
 * Data for filling the OpenDroneID Self ID message. The Self ID Message is an opportunity for the operator to (optionally) declare their identity and purpose of the flight. This message can provide additional information that could reduce the threat profile of a UA (Unmanned Aircraft) flying in a particular area or manner.</br>
 * </br>
 ...
 */
@Deprecated
@MavInfo(id = 12903, crc = 249)
@SuppressWarnings("preview")
public record OpenDroneIdSelfId(
        /**
        ...
        /**
         * Indicates the type of the description field.</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         */
        @MavField(nativeType = NativeType.UINT_8)
        @JsonProperty int descriptionType, 
        /**
        ...
        @JsonProperty int[] description) implements MavlinkMessage {
    /**
     * There shall be no default-constructor for normal developers.
     */
    @SuppressWarnings("unused")
    private OpenDroneIdSelfId() {
