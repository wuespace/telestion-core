 ...
 */
@MavInfo(id = 257, crc = 131)
@SuppressWarnings("preview")
public record ButtonChange(
        /**
        ...
        /**
         * Time of last change of button state.</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         */
        @MavField(nativeType = NativeType.UINT_32)
        @JsonProperty long lastChangeMs, 
        /**
         * Bitmap for state of buttons.</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         */
        @MavField(nativeType = NativeType.UINT_8)
        @JsonProperty int state) implements MavlinkMessage {
    /**
     * There shall be no default-constructor for normal developers.
     */
    @SuppressWarnings("unused")
    private ButtonChange() {
        this(0, 0, 0);
    }
}