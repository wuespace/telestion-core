 ...
 */
@MavInfo(id = 157, crc = 133)
@SuppressWarnings("preview")
public record FlexifunctionCommand(
        /**
         * System ID</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
        ...
        /**
         * Flexifunction command type</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         */
        @MavField(nativeType = NativeType.UINT_8)
        @JsonProperty int commandType) implements MavlinkMessage {
    /**
     * There shall be no default-constructor for normal developers.
     */
    @SuppressWarnings("unused")
    private FlexifunctionCommand() {
        this(0, 0, 0);
    }
}