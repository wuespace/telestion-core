...
/**
 * Request a GOPRO_COMMAND response from the GoPro.</br>
 * </br>
 ...
 */
@MavInfo(id = 216, crc = 50)
@SuppressWarnings("preview")
public record GoproGetRequest(
        /**
         * System ID.</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         ...
         */
        @MavField(nativeType = NativeType.UINT_8)
        @JsonProperty int cmdId) implements MavlinkMessage {
    /**
     * There shall be no default-constructor for normal developers.
     */
    @SuppressWarnings("unused")
    private GoproGetRequest() {
        this(0, 0, 0);
    }
}