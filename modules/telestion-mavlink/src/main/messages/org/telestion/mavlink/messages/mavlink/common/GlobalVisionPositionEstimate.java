...
/**
 * Global position/attitude estimate from a vision source.</br>
 * </br>
 ...
 */
@MavInfo(id = 101, crc = 102)
@SuppressWarnings("preview")
public record GlobalVisionPositionEstimate(
        /**
         * Timestamp (UNIX time or since system boot)</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         */
        ...
        /**
         * Row-major representation of pose 6x6 cross-covariance matrix upper right triangle (states: x_global, y_global, z_global, roll, pitch, yaw; first six entries are the first ROW, next five entries are the second ROW, etc.). If unknown, assign NaN value to first element in the array.</br>
         * </br>
         * <i>Autogenerated by XML2Record-Tool v1.3.7</i>
         */
        @MavArray(length = 21)
    ...
    private GlobalVisionPositionEstimate() {
