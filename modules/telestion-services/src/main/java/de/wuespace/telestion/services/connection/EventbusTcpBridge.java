...
public final class EventbusTcpBridge extends AbstractVerticle {
	...
	private Router bridgeHandler(List<String> inboundPermitted, List<String> outboundPermitted) {
		...
		// allow UUID reply addresses generated by client
		sockJsBridgeOptions.addInboundPermitted(
				new PermittedOptions()
						.setAddressRegex("\\b[0-9a-f]{8}\\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\\b[0-9a-f]{12}\\b")
		);
