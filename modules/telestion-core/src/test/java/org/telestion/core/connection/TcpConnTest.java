...
public class TcpConnTest {
    ...
    void roundTripTest(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        var server = new TcpConn(null, 23654,
                serverOutgoing, null, Collections.singletonList(serverIncoming));
        var client = new TcpConn("127.0.0.1", 23654,
                clientOutgoing, null, Collections.singletonList(clientIncoming));
